...
namespace TSWMod.TSW
{
    class USDefaultKeyboardLayout : IKeyboardLayout
    {
        ...
        public virtual InputHelpers.VKCodes[] CabLightDecrease => new[] { InputHelpers.VKCodes.VK_LSHIFT, InputHelpers.VKCodes.VK_L };
        public virtual InputHelpers.VKCodes[] CabLightIncrease => new[] { InputHelpers.VKCodes.VK_L };
        ...
        public virtual InputHelpers.VKCodes[] HandbrakeToggle => new[] {InputHelpers.VKCodes.VK_OEM_5};
        ...
        public virtual InputHelpers.VKCodes[] LightDecrease => new[] { InputHelpers.VKCodes.VK_LSHIFT, InputHelpers.VKCodes.VK_H };
        public virtual InputHelpers.VKCodes[] LightIncrease => new[] { InputHelpers.VKCodes.VK_H };
        public virtual InputHelpers.VKCodes[] MasterSwitch => new[] { InputHelpers.VKCodes.VK_LCONTROL, InputHelpers.VKCodes.VK_W };
        ...
        public virtual InputHelpers.VKCodes[] SignalingSystem => new[] {InputHelpers.VKCodes.VK_LCONTROL, InputHelpers.VKCodes.VK_RETURN};
        ...
        public virtual InputHelpers.VKCodes[] WarningDevice => new[] { InputHelpers.VKCodes.VK_LSHIFT, InputHelpers.VKCodes.VK_RETURN };
        public virtual InputHelpers.VKCodes[] WiperDecrease => new[] { InputHelpers.VKCodes.VK_LSHIFT, InputHelpers.VKCodes.VK_V };
        public virtual InputHelpers.VKCodes[] WiperIncrease => new[] { InputHelpers.VKCodes.VK_V };
    }
}