    ...
    class TSWConnector
    {
        ...
        private void AddIfPtrIsKnownLocomotive(UIntPtr ptr)
        {
            ...
            lock (_locomotivesLock)
            {
                ...
                else if (possibleName.Contains(Class66.NamePartial))
                {
                    _foundLocomotives.Add(ptr, new Class66(_m, ptr, _currentProcess.MainWindowHandle));
                }
                else if (possibleName.Contains(Class166.NamePartial))
                {
                    _foundLocomotives.Add(ptr, new Class166(_m, ptr, _currentProcess.MainWindowHandle));
                }
                else if (possibleName.Contains(BR422.NamePartial) || possibleName.Contains(BR422.NamePartial2))
                {
